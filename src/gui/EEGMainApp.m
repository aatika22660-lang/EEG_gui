classdef EEGMainApp < matlab.apps.AppBase
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            uilabel(app.InputFilePanel, 'Position', [15 62 80 20], ...   % was 55 → 62
            ...
            uilabel(app.OutputPanel, 'Position', [15 62 80 20], ...      % was 55 → 62
            ...
            uilabel(app.ParamsPanel, 'Position', [15 62 400 20], ...     % was 55 → 62
            ...
            uilabel(app.ParamsPanel, 'Position', [250 62 200 20], ...    % was 55 → 62
    ...
    methods (Access = public)
        ...
        function app = EEGMainApp(filepath)
            ...
            % Auto-load file if passed from landing page
